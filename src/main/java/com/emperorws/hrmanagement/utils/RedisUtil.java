...
public class RedisUtil {
    ...
    /**
     * 实现命令：TTL key，以秒为单位，返回给定 key的剩余生存时间(TTL, time to live)/毫秒单位。
     *
     * @param key
     * @return
     */
     ...
     * @param field
     */
    public boolean hfind(String key, String field){
        return redisTemplate.opsForHash().entries(key).containsKey(field);
    }
    ...
    public void hset(String key, HashMap<String,Object> hm){
        ...
        expire(key,expirationMilliSeconds);
    }
