...
public interface SalaryadjustmentMapper {
    ...
    List<Salaryadjustment> getSalaryadjustmentByPage(@Param("page") Integer page, @Param("size") Integer size, @Param("sa") Salaryadjustment salaryadjustment, @Param("sadata") Date[] sadata);

    Long getTotal(@Param("sa") Salaryadjustment employeechange, @Param("sadata") Date[] sadata);
}
